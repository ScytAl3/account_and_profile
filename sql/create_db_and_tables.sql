...
INSERT INTO 
    users(lastName, firstName, dateOfBirth, placeOfBirth, email, password, salt, presentation, role, created_at) 
VALUES 
    ('Doe', 'John', null, null, 'j.doe@example.com', '54e4feb636204d1e5fcf49fb202946db', 'b7c8cb5b20beb2733470a65bb59722de', null, default, now()),    -- az3rty
    ( 'Jobs', 'Steve', '1955-02-24', 'San Francisco', 'amazing@example.com', '1f1c153c6717024f825a862901f9c3bc', '476e62fcde5fcaa1e7fc2629da120ce9', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc omni virtuti vitium contrario nomine opponitur. Quod cum dixissent, ille contra. Summus dolor plures dies manere non potest? Sed plane dicit quod intellegit. Quamquam id quidem, infinitum est in hac urbe', default, now());  -- 4pple 
